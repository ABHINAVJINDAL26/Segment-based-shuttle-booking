...
import com.movinsync.shuttle.service.AuthService;
...
@Tag(name = "Authentication", description = "Endpoints for employee registration and JWT authentication")
public class AuthController {

    private final AuthService authService;

    @PostMapping("/register")
    @Operation(summary = "Register a new user (EMPLOYEE or ADMIN)")
